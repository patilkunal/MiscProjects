...
set CC_OPTS=-Xms128m -Xmx300m
set ANT_OPTS=-Xms200m
...
set CRUISE_PATH=%CRUISE_PATH%;%LIBDIR%\ant-junit.jar
...
set EXEC="%JAVA_HOME%\bin\java" %CC_OPTS% -cp "%CRUISE_PATH%" -Djavax.management.builder.initial=mx4j.server.MX4JMBeanServerBuilder CruiseControlWithJetty %* -jmxport 8000 -webport 9090
echo %EXEC%
%EXEC%
